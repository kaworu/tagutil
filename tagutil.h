 ...
 * year tag.
 */
typedef bool (*tagutil_f)(const char *restrict, TagLib_File *restrict, const char *restrict);
 ...
 */
bool tagutil_print(const char *restrict path, TagLib_File *restrict f, const char *restrict arg)
    __attribute__ ((__nonnull__ (1, 2)));
 ...
 */
bool tagutil_edit(const char *restrict path, TagLib_File *restrict f, const char *restrict arg)
    __attribute__ ((__nonnull__ (1, 2)));
 ...
 */
bool tagutil_rename(const char *restrict path, TagLib_File *restrict f, const char *restrict arg)
    __attribute__ ((__nonnull__ (1, 2, 3)));

/* functions below are generated by the _MAKE_TAGUTIL_FUNC macro. */
bool tagutil_title(const char *restrict path, TagLib_File *restrict f, const char *restrict arg)
    __attribute__ ((__nonnull__ (1, 2, 3)));
bool tagutil_album(const char *restrict path, TagLib_File *restrict f, const char *restrict arg)
    __attribute__ ((__nonnull__ (1, 2, 3)));
bool tagutil_artist(const char *restrict path, TagLib_File *restrict f, const char *restrict arg)
    __attribute__ ((__nonnull__ (1, 2, 3)));
bool tagutil_year(const char *restrict path, TagLib_File *restrict f, const char *restrict arg)
    __attribute__ ((__nonnull__ (1, 2, 3)));
bool tagutil_track(const char *restrict path, TagLib_File *restrict f, const char *restrict arg)
    __attribute__ ((__nonnull__ (1, 2, 3)));
bool tagutil_comment(const char *restrict path, TagLib_File *restrict f, const char *restrict arg)
    __attribute__ ((__nonnull__ (1, 2, 3)));
bool tagutil_genre(const char *restrict path, TagLib_File *restrict f, const char *restrict arg)
    __attribute__ ((__nonnull__ (1, 2, 3)));
